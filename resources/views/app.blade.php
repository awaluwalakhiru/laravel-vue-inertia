...
.min.css" />
    ...
    <script src="{{
asset('/admin/js/coreui.bundle.min.js') }}" defer></script>

    <script src="{{
mix('/js/app.js') }}" defer></script>
